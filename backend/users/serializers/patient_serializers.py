...
class PatientListSerializer(serializers.Serializer):
    ...
    emergency_contact_name = serializers.CharField(allow_null=True, allow_blank=True)
    emergency_contact_phone = serializers.CharField(allow_null=True, allow_blank=True)
    ...
    blood_group_id = serializers.IntegerField(allow_null=True)
